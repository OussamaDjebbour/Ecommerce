      ...
      <div className="flex flex-col items-start gap-4 sm:flex-row sm:gap-6">
        ...
        >
          <img
            src={item.image}
            alt={item.title || "Product"}
            // className={`h-24 w-24 rounded-lg border border-gray-200 object-cover group-hover:border-teal-200 sm:h-28 sm:w-28 lg:h-20 lg:w-20 xl:h-24 xl:w-24`}
